...
import (
	...
	command_inbound_adapter "go-boilerplate/internal/adapter/inbound/command"
	fiber_inbound_adapter "go-boilerplate/internal/adapter/inbound/fiber"
	rabbitmq_inbound_adapter "go-boilerplate/internal/adapter/inbound/rabbitmq"
	postgres_outbound_adapter "go-boilerplate/internal/adapter/outbound/postgres"
	rabbitmq_outbound_adapter "go-boilerplate/internal/adapter/outbound/rabbitmq"
	redis_outbound_adapter "go-boilerplate/internal/adapter/outbound/redis"
	"go-boilerplate/internal/domain"
	_ "go-boilerplate/internal/migration/postgres"
	outbound_port "go-boilerplate/internal/port/outbound"
	"go-boilerplate/utils"
	"go-boilerplate/utils/activity"
	"go-boilerplate/utils/database"
